...
function App() {
  ...
  return (
    ...
    <div className="overflow-x-hidden">
      ...
      {/* Hero section */}
      <section className="ml-[30px] lg:ml-30 px-4 md:px-8">
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          ...
          <div className="mt-6 md:mt-0 flex justify-center">
            <img
              src={hero}
              className="h-[300px] mr-[50px] sm:h-[400px] md:h-[600px] pb-[40px] md:pb-[100px]"
            />
          </div>
        </div>
      </section>
...
{/* */}
              <div className="grid grid-cols-2 lg:grid-cols-3 lg:ml-[300px] lg:mr-[250px] gap-y-6 ml-[40px]">
                    {womanPic.map((womanPic,index) => (
                      <div keys={index}>
                        ...
                        <p className="text-[#bf6159] lg:ml-[40px] ml-[40px] text-[15px]">{womanPic.label}</p>
                      </div>
                    ))}
              </div>
  ...
  <div className="grid grid-cols-1">
    {/* Block 1 */}
    <div className="flex flex-col  md:flex-row lg:ml-[300px]  gap-6 md:gap-10 mb-12">
    ...
    {/* Block 2 */}
     <div className="flex flex-col md:flex-row-reverse  lg:mr-[450px] gap-2 mb-12">
  ...
  {/* Final Section */}
  <div className="flex flex-col md:flex-row items-center md:ml-[100px] mt-[80px] gap-6 md:gap-1 px-4 lg:px-30  ">
...
<section className="px-4 lg:px-70">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 lg:gap-x-12 lg:gap-y-8">
    {[1, 2, 3, 4].map((i) => (
  ...
  <div className="flex flex-col md:flex-row lg:flex-row lg:mr-[50px] mt-16 lg:mt-20 gap-6 lg:gap-x-10 items-center ">
    <img src={woman5} className="w-[250px] md:w-[280px] lg:w-[400px]" />
    <div className="flex flex-col text-center md:text-left md:mb-30">
      <h2 className="leading-[40px] md:leading-[45px] lg:leading-[50px] mb-3 font-[400] text-[24px] md:text-[30px] lg:text-[40px] text-[#BF6159] md:w-[350px] ">
        Lorem Ipsum Dolor Sit Amet
      </h2>
  ...
  <div className="flex flex-col md:flex-row lg:flex-row-reverse lg:ml-[300px] mt-16 lg:mt-20 gap-6 lg:gap-x-10 items-center">
    <img src={woman5} className="w-[250px] md:w-[280px] lg:w-[400px]" />
